...
def vasp_inputs_creator(num_of_structures: int, out_dir='vasp_inputs', input_directory='user_inputs'):
    """
    Args:
...
def get_coefficients(poscars_to_check: list, fake_magnetic_atoms: list, up_to=2) -> list:
    """
